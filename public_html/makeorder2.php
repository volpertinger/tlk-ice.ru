...
<label>Выбрать город: <select size='1' name='city'><option value=''></option>";
...
";
echo "<label> Количество отправок: <select size='1' name='td'>";
...
echo "<br><input type='submit' name='choose' value='Выбрать'>
...
<tr>
    <td width='270px'><div align='center'>Получатели в г. $city</div></td>
    
    <td width='70'><div align='center'>Объем, паллет</div></td>
    <td width='70'><div align='center'>Вес, кг</div></td>
	<td width='70'><div align='center'>Коробок</div></td>
	<td width='70'><div align='center'>Сумма</div></td>
	<td width='70'><div align='center'>Накладная</div></td>
	<td width='70'><div align='center'>Дата накладной</div></td>
...
echo "<input type='submit' name = 'path'  style='width: 320px;' value='Отправить'/></form>";
