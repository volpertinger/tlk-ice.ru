...
$orderid=$row["orderid"];
			...
			echo "<div class='client'>Редактирование заказа №$orderid. <br>Заполнение спецификации</div>
...
<input name='orderdate2' type='hidden' value='".$ol["ol_datein"]."'>
<input name='orderdate' type='hidden' value='".$ol["ol_datein"]."'>
...
<input name='dateout' type='hidden' value='".$ol["ol_dateout"]."'>
<input type='hidden'  name='orderid' value='$orderid'>
<input name='clientid' type='hidden' value='".$ol["ol_clientid"]."'>
<input type='submit' name='sendmoder' value='Отправить изменения на премодерацию'>
</form>";
}else{
...
echo "<p><input type='submit' name = 'path'  style='width: 320px;' value='Переход к премодерации изменений'/></form>";
