...
# проверяем совпадения паролей
 ...
 $err[] = "Пароли не совпадают";
...

    {
		...
		$to = "$clientmail"; /*УКАЗАТЬ СВОЙ АДРЕС!*/
...
$send = mail ($to, $subject, $message, $headers);
		...
		if ($send == 'true')
{
print "<b><span style='font-size:16px'>Уведомление отправлено на $clientmail</span></b><br><hr>";
}
else 
{
...
<input name='submit' type='submit' value='Зарегистрировать' style='font-size:20px'>
