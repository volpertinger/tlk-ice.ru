...
echo "<div class='exit'><form method='post' action=''>
        ...
        </form></div><div class='client'>КАЛЕНДАРНЫЙ ПЛАН</div><div class='right'>";
...
if ($result)
{
echo "<b><span style='font-size:16px'>Удалено</b> - <i>$cdate</i></span><br><hr>";
...
if ($result)
{
echo "<b><span style='font-size:16px'>Внескны изменения на дату</b> - <i>$cdate</i></span><br><hr>";
